...
export function parseReturnStmt(code: string): ParseData{
    ...
    if (keyword.deliverable.name !== "return"){
        return undefined;
    }
    ...
    result = {
        remain: block.remain,
        deliverable: {nodeType: "RETURN_STMT", body: expr.deliverable as AstExpr, block: block.deliverable as AstCodeBlock}
    }
